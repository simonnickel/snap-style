...
public struct StyleStack<Content>: View where Content: View {
    ...
    package static func spacing(for keyPath: Style.Keys.Number.ValueBuilderKeyPath?, with style: Style.ContextWrapper) -> Style.Keys.Number.Value.WrappedValue {
...
#Preview {
    ...
    @Previewable @State var spacing: Style.Keys.Number.ValueBuilderKeyPath? = nil
