...
extension View {
    ...
    public func style(spacing keyPath: Style.Attributes.Number.ValueBuilderKeyPath?) -> some View {
...
extension EnvironmentValues {
    ...
    @Entry package var styleStackSpacing: Style.Attributes.Number.ValueBuilderKeyPath? = nil
