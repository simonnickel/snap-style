...
extension View {
    ...
    public func style(spacing keyPath: Style.Keys.NumberKey.ValueBuilderKeyPath?) -> some View {
...
extension EnvironmentValues {
    ...
    @Entry package var styleStackSpacing: Style.Keys.NumberKey.ValueBuilderKeyPath? = nil
