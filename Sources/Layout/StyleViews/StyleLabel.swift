...
public struct StyleLabel<Content: View>: View {
    ...
    public typealias IconKeyPath = Style.Keys.IconKey.ValueBuilderKeyPath
...
extension EnvironmentValues {
    @Entry var styleLabelSpacing: Style.Keys.NumberKey.ValueBuilderKeyPath = \.spacingLabel
...
extension LabelStyle where Self == CustomSpacingLabelStyle {
    static func style(spacing: Style.Keys.NumberKey.ValueBuilderKeyPath) -> CustomSpacingLabelStyle {
...
struct CustomSpacingLabelStyle: LabelStyle {
    ...
    let spacing: Style.Keys.NumberKey.ValueBuilderKeyPath
