...
extension View {
    ...
    public func style(font keyPath: Style.Keys.Font.ValueBuilderKeyPath) -> some View {
...
private struct ScaledFont: ViewModifier {
    ...
    private let definition: Style.Keys.Font.Value.Definition?
    private let scaled: ScaledMetric<Double>

    init(definition: Style.Keys.Font.Value.Definition?) {
