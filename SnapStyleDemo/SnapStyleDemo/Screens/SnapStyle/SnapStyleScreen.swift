...
struct SnapStyleScreen: View {
    ...
    struct ViewData {
        ...
        static let views: ViewData = ViewData(sections: [
            Section(title: "Views", screens: [.viewStyleStack, .viewScrollingHStack, .viewStyleFlowLayout, .viewStyleScreen, .viewStyleList, .viewStyleListRow, .viewStyleListSectionHeaderLabel, .viewStyleListSectionFooterLabel, .viewStyleSpacer]),
        ])
    }
